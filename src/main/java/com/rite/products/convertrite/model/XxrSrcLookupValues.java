...
@Entity
@Table(name = "XXR_SRC_LOOKUP_VALUES")
public class XxrSrcLookupValues {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "src_lookup_values_generator")
	@SequenceGenerator(name = "src_lookup_values_generator", sequenceName = "xxr_src_lookup_values_id_s", allocationSize = 1)
